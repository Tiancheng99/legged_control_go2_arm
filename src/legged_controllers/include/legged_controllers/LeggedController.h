...
class LeggedController : public controller_interface::MultiInterfaceController<HybridJointInterface, hardware_interface::ImuSensorInterface,
 ...
 public:
  ...
  //void armAnglesCallback(const sensor_msgs::JointState::ConstPtr& msg) override;
  //-----角度订阅-----
 ...
 protected:
  ...
  void armAnglesCallback(const geometry_msgs::Vector3::ConstPtr& msg);
  // Interface
  ...
  //-----角度订阅-----
  ros::Subscriber armAnglesSub_;
  Eigen::Vector3d jointAngles_;
 private:
